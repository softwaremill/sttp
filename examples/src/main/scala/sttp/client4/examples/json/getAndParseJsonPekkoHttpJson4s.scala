...
//> using dep com.softwaremill.sttp.client4::json4s:4.0.25
//> using dep com.softwaremill.sttp.client4::pekko-http-backend:4.0.25
//> using dep org.json4s::json4s-native:4.1.1
