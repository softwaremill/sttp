...
/** Contains the timings of different parts of the response processing.
  ...
  * @param bodyHandled
  *   The time it took from sending the request, to handling the entire response body (e.g. including parsing).
  */
case class ResponseTimings(bodyReceived: Option[Duration], bodyHandled: Duration)
