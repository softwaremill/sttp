...
/**
  ...
  * @tparam F The effect type used when returning responses. E.g. [[Identity]] for synchronous backends,
  *           [[scala.concurrent.Future]] for asynchronous backends.
  * @tparam P Capabilities supported by this backend, in addition to [[Effect]]. This might be `Any` (no special
  *           capabilities), [[Streams]] (the ability to send and receive streaming bodies) or
  *           [[WebSockets]] (the ability to handle websocket requests).
  */
