# -*- coding: utf-8 -*-
#
# sttp client documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'sttp.tex', u'sttp client Documentation',
...
man_pages = [
    (master_doc, 'sttp', u'sttp client Documentation',
     [author], 1)
]
