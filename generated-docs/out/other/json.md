...
```scala
"com.softwaremill.sttp.client4" %% "circe" % "4.0.0-M26"
```
...
```
"com.softwaremill.sttp.client4" %% "json4s" % "4.0.0-M26"
...
```
"com.softwaremill.sttp.client4" %% "spray-json" % "4.0.0-M26"
```
...
```scala
"com.softwaremill.sttp.client4" %% "play-json" % "4.0.0-M26"
```

If you use older version of play (2.9.x), add the following dependency to your project:

```scala
"com.softwaremill.sttp.client4" %% "play29-json" % "4.0.0-M26"
```
...
```scala
"com.softwaremill.sttp.client4" %% "zio-json" % "4.0.0-M26"  // for ZIO 2.x
"com.softwaremill.sttp.client4" %% "zio1-json" % "4.0.0-M26" // for ZIO 1.x
```
...
```scala
"com.softwaremill.sttp.client4" %% "jsoniter" % "4.0.0-M26"
```
