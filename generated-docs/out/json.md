...
```
"com.softwaremill.sttp.client3" %% "spray-json" % "3.8.16"
```
...
"com.softwaremill.sttp.client3" %% "zio1-json" % "3.8.16" // for ZIO 1.x
```
...
```scala
"com.softwaremill.sttp.client3" %% "jsoniter" % "3.8.16"
```
