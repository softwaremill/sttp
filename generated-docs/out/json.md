...
```
"com.softwaremill.sttp.client3" %% "spray-json" % "3.4.2"
```
...
```scala
"com.softwaremill.sttp.client3" %% "play-json" % "3.4.2"
```
...
```scala
"com.softwaremill.sttp.client3" %% "zio-json" % "3.4.2"  // for ZIO 2.x
"com.softwaremill.sttp.client3" %% "zio1-json" % "3.4.2" // for ZIO 1.x
```
...
```scala
"com.softwaremill.sttp.client3" %% "jsoniter-json" % "3.4.2"
```
