...
```scala
"com.softwaremill.sttp.client3" %% "play-json" % "3.8.3"
```
...
```scala
"com.softwaremill.sttp.client3" %% "zio-json" % "3.8.3"  // for ZIO 2.x
"com.softwaremill.sttp.client3" %% "zio1-json" % "3.8.3" // for ZIO 1.x
```
...
```scala
"com.softwaremill.sttp.client3" %% "jsoniter-json" % "3.8.3"
```
