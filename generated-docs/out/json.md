...
```
"com.softwaremill.sttp.client3" %% "spray-json" % "3.9.6"
```
...
```scala
"com.softwaremill.sttp.client3" %% "play2-json" % "3.9.6"
```
...
```scala
"com.softwaremill.sttp.client3" %% "zio-json" % "3.9.6"  // for ZIO 2.x
"com.softwaremill.sttp.client3" %% "zio1-json" % "3.9.6" // for ZIO 1.x
```
...
```scala
"com.softwaremill.sttp.client3" %% "jsoniter" % "3.9.6"
```
...
```scala
"com.softwaremill.sttp.client3" %% "upickle" % "3.9.6"
```
