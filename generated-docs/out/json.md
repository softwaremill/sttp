...
```
"com.softwaremill.sttp.client4" %% "spray-json" % "4.0.0-M16"
```
...
```scala
"com.softwaremill.sttp.client4" %% "play-json" % "4.0.0-M16"
```

If you use older version of play (2.9.x), add the following dependency to your project:

```scala
"com.softwaremill.sttp.client4" %% "play29-json" % "4.0.0-M16"
```
...
```scala
"com.softwaremill.sttp.client4" %% "zio-json" % "4.0.0-M16"  // for ZIO 2.x
"com.softwaremill.sttp.client4" %% "zio1-json" % "4.0.0-M16" // for ZIO 1.x
```
