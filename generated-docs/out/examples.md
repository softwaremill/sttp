...
```scala            
libraryDependencies ++= List("com.softwaremill.sttp.client" %% "core" % "3.0.0-RC2")
```
...
libraryDependencies ++= List(
  ...
  "com.softwaremill.sttp.client" %% "json4s" % "3.0.0-RC2",
...
libraryDependencies ++= List(
  ...
  "com.softwaremill.sttp.client" %% "circe" % "3.0.0-RC2",
...
```scala
libraryDependencies ++= List("com.softwaremill.sttp.client" %% "async-http-client-backend-zio" % "3.0.0-RC2")
```
...
```scala
libraryDependencies ++= List("com.softwaremill.sttp.client" %% "async-http-client-backend-fs2 % "3.0.0-RC2")
```
...
```scala
libraryDependencies ++= List("com.softwaremill.sttp.client" %% "async-http-client-backend-monix % "3.0.0-RC2")
```
...
```scala
libraryDependencies ++= List("com.softwaremill.sttp.client" %% "akka-http-backend" % "3.0.0-RC2")
```
