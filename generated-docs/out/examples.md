...
```scala            
libraryDependencies ++= List("com.softwaremill.sttp.client3" %% "core" % "3.7.1")
```
...
libraryDependencies ++= List(
  ...
  "com.softwaremill.sttp.client3" %% "json4s" % "3.7.1",
...
```scala
libraryDependencies ++= List(
  "com.softwaremill.sttp.client3" %% "async-http-client-backend-monix" % "3.7.1",
  "com.softwaremill.sttp.client3" %% "circe" % "3.7.1",
  "io.circe" %% "circe-generic" % "0.14.1"
)
```
...
```scala
libraryDependencies ++= List(
  "com.softwaremill.sttp.client3" %% "slf4j-backend" % "3.7.1",
  "com.softwaremill.sttp.client3" %% "circe" % "3.7.1",
  "io.circe" %% "circe-generic" % "0.14.1"
)
```
...
```scala
libraryDependencies ++= List("com.softwaremill.sttp.client3" %% "async-http-client-backend-zio" % "3.7.1")
```
...
```scala
libraryDependencies ++= List("com.softwaremill.sttp.client3" %% "async-http-client-backend-fs2" % "3.7.1")
```
...
```scala
libraryDependencies ++= List("com.softwaremill.sttp.client3" %% "async-http-client-backend-monix" % "3.7.1")
```
...
```scala
libraryDependencies ++= List("com.softwaremill.sttp.client3" %% "akka-http-backend" % "3.7.1")
```
