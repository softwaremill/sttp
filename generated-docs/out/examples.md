...
```scala            
libraryDependencies ++= List("com.softwaremill.sttp.client3" %% "core" % "3.9.7")
```
...
libraryDependencies ++= List(
  ...
  "com.softwaremill.sttp.client3" %% "json4s" % "3.9.7",
...
```scala
libraryDependencies ++= List("com.softwaremill.sttp.client3" %% "zio" % "3.9.7")
```
...
```scala
libraryDependencies ++= List("com.softwaremill.sttp.client3" %% "fs2" % "3.9.7")
```
...
```scala
libraryDependencies ++= List("com.softwaremill.sttp.client3" %% "monix" % "3.9.7")
```
...
```scala
libraryDependencies ++= List("com.softwaremill.sttp.client3" %% "akka-http-backend" % "3.9.7")
```
...
```scala
libraryDependencies ++= List("com.softwaremill.sttp.client3" %% "pekko-http-backend" % "3.9.7")
```
