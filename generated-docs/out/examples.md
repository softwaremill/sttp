...
```scala            
libraryDependencies ++= List("com.softwaremill.sttp.client3" %% "core" % "3.1.9")
```
...
libraryDependencies ++= List(
  "com.softwaremill.sttp.client3" %% "akka-http-backend" % "3.1.9",
...
```scala
libraryDependencies ++= List(
  "com.softwaremill.sttp.client3" %% "async-http-client-backend-monix" % "3.1.9",
  "com.softwaremill.sttp.client3" %% "circe" % "3.1.9",
  "io.circe" %% "circe-generic" % "0.13.0"
)
```
...
```scala
libraryDependencies ++= List("com.softwaremill.sttp.client3" %% "async-http-client-backend-zio" % "3.1.9")
```
...
```scala
libraryDependencies ++= List("com.softwaremill.sttp.client3" %% "async-http-client-backend-fs2 % "3.1.9")
```
...
```scala
libraryDependencies ++= List("com.softwaremill.sttp.client3" %% "async-http-client-backend-monix % "3.1.9")
```
...
```scala
libraryDependencies ++= List("com.softwaremill.sttp.client3" %% "akka-http-backend" % "3.1.9")
```
