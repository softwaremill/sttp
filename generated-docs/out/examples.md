...
```scala            
libraryDependencies ++= List("com.softwaremill.sttp.client3" %% "core" % "3.10.2")
```
...
libraryDependencies ++= List(
  "com.softwaremill.sttp.client3" %% "akka-http-backend" % "3.10.2",
...
```scala
libraryDependencies ++= List(
  "com.softwaremill.sttp.client3" %% "monix" % "3.10.2",
  "com.softwaremill.sttp.client3" %% "circe" % "3.10.2",
  "io.circe" %% "circe-generic" % "0.14.10"
)
```
...
```scala
libraryDependencies ++= List("com.softwaremill.sttp.client3" %% "zio" % "3.10.2")
```
...
```scala
libraryDependencies ++= List("com.softwaremill.sttp.client3" %% "fs2" % "3.10.2")
```
...
```scala
libraryDependencies ++= List("com.softwaremill.sttp.client3" %% "monix" % "3.10.2")
```
...
```scala
libraryDependencies ++= List("com.softwaremill.sttp.client3" %% "akka-http-backend" % "3.10.2")
```
...
```scala
libraryDependencies ++= List("com.softwaremill.sttp.client3" %% "pekko-http-backend" % "3.10.2")
```
