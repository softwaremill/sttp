...
```scala            
libraryDependencies ++= List("com.softwaremill.sttp.client4" %% "core" % "4.0.0-M14")
```
...
libraryDependencies ++= List(
  ...
  "com.softwaremill.sttp.client4" %% "json4s" % "4.0.0-M14",
...
```scala
libraryDependencies ++= List("com.softwaremill.sttp.client4" %% "zio" % "4.0.0-M14")
```
...
```scala
libraryDependencies ++= List("com.softwaremill.sttp.client4" %% "fs2" % "4.0.0-M14")
```
...
```scala
libraryDependencies ++= List("com.softwaremill.sttp.client4" %% "monix" % "4.0.0-M14")
```
...
```scala
libraryDependencies ++= List("com.softwaremill.sttp.client4" %% "akka-http-backend" % "4.0.0-M14")
```
...
```scala
libraryDependencies ++= List("com.softwaremill.sttp.client4" %% "pekko-http-backend" % "4.0.0-M14")
```
