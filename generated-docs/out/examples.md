...
```scala            
libraryDependencies ++= List("com.softwaremill.sttp.client3" %% "core" % "3.4.2")
```
...
libraryDependencies ++= List(
  ...
  "com.softwaremill.sttp.client3" %% "json4s" % "3.4.2",
...
```scala
libraryDependencies ++= List(
  "com.softwaremill.sttp.client3" %% "async-http-client-backend-zio" % "3.4.2",
  "com.softwaremill.sttp.client3" %% "circe" % "3.4.2",
...
```scala
libraryDependencies ++= List(
  "com.softwaremill.sttp.client3" %% "async-http-client-backend-monix" % "3.4.2",
  "com.softwaremill.sttp.client3" %% "circe" % "3.4.2",
  "io.circe" %% "circe-generic" % "0.14.1"
)
```
...
```scala
libraryDependencies ++= List(
  "com.softwaremill.sttp.client3" %% "slf4j-backend" % "3.4.2",
  "com.softwaremill.sttp.client3" %% "circe" % "3.4.2",
  "io.circe" %% "circe-generic" % "0.14.1"
)
```
...
```scala
libraryDependencies ++= List("com.softwaremill.sttp.client3" %% "async-http-client-backend-zio" % "3.4.2")
```
...
```scala
libraryDependencies ++= List("com.softwaremill.sttp.client3" %% "async-http-client-backend-fs2" % "3.4.2")
```
...
```scala
libraryDependencies ++= List("com.softwaremill.sttp.client3" %% "async-http-client-backend-monix" % "3.4.2")
```
...
```scala
libraryDependencies ++= List("com.softwaremill.sttp.client3" %% "akka-http-backend" % "3.4.2")
```
