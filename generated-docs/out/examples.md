...
```scala            
libraryDependencies ++= List("com.softwaremill.sttp.client3" %% "core" % "3.3.15")
```
...
libraryDependencies ++= List(
  "com.softwaremill.sttp.client3" %% "akka-http-backend" % "3.3.15",
  "com.softwaremill.sttp.client3" %% "json4s" % "3.3.15",
...
```scala
libraryDependencies ++= List("com.softwaremill.sttp.client3" %% "async-http-client-backend-zio" % "3.3.15")
```
...
```scala
libraryDependencies ++= List("com.softwaremill.sttp.client3" %% "async-http-client-backend-fs2 % "3.3.15")
```
...
```scala
libraryDependencies ++= List("com.softwaremill.sttp.client3" %% "async-http-client-backend-monix" % "3.3.15")
```
...
```scala
libraryDependencies ++= List("com.softwaremill.sttp.client3" %% "akka-http-backend" % "3.3.15")
```
