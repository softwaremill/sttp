...
```scala            
libraryDependencies ++= List("com.softwaremill.sttp.client4" %% "core" % "4.0.0-M11")
```
...
libraryDependencies ++= List(
  "com.softwaremill.sttp.client4" %% "akka-http-backend" % "4.0.0-M11",
...
```scala
libraryDependencies ++= List(
  "com.softwaremill.sttp.client4" %% "monix" % "4.0.0-M11",
  "com.softwaremill.sttp.client4" %% "circe" % "4.0.0-M11",
  "io.circe" %% "circe-generic" % "0.14.6"
)
```
...
```scala
libraryDependencies ++= List(
  "com.softwaremill.sttp.client4" %% "slf4j-backend" % "4.0.0-M11",
  "com.softwaremill.sttp.client4" %% "circe" % "4.0.0-M11",
  "io.circe" %% "circe-generic" % "0.14.6"
)
```
...
```scala
libraryDependencies ++= List("com.softwaremill.sttp.client4" %% "zio" % "4.0.0-M11")
```
...
```scala
libraryDependencies ++= List("com.softwaremill.sttp.client4" %% "fs2" % "4.0.0-M11")
```
...
```scala
libraryDependencies ++= List("com.softwaremill.sttp.client4" %% "monix" % "4.0.0-M11")
```
...
```scala
libraryDependencies ++= List("com.softwaremill.sttp.client4" %% "akka-http-backend" % "4.0.0-M11")
```
...
```scala
libraryDependencies ++= List("com.softwaremill.sttp.client4" %% "pekko-http-backend" % "4.0.0-M11")
```
