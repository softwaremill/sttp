...
```scala            
libraryDependencies ++= List("com.softwaremill.sttp.client" %% "core" % "2.2.3")
```
...
libraryDependencies ++= List(
  "com.softwaremill.sttp.client" %% "akka-http-backend" % "2.2.3",
  "com.softwaremill.sttp.client" %% "json4s" % "2.2.3",
...
```scala
libraryDependencies ++= List(
  "com.softwaremill.sttp.client" %% "async-http-client-backend-monix" % "2.2.3",
  "com.softwaremill.sttp.client" %% "circe" % "2.2.3",
  "io.circe" %% "circe-generic" % "0.12.1"
)
```
...
```scala
libraryDependencies ++= List("com.softwaremill.sttp.client" %% "async-http-client-backend-zio" % "2.2.3")
```
...
```scala
libraryDependencies ++= List("com.softwaremill.sttp.client" %% "async-http-client-backend-monix" % "2.2.3")
```
...
```scala
libraryDependencies ++= List("com.softwaremill.sttp.client" %% "async-http-client-backend-fs2" % "2.2.3")
```
