...
```scala            
libraryDependencies ++= List("com.softwaremill.sttp.client3" %% "core" % "3.0.0-RC3")
```
...
libraryDependencies ++= List(
  "com.softwaremill.sttp.client3" %% "akka-http-backend" % "3.0.0-RC3",
...
```scala
libraryDependencies ++= List(
  "com.softwaremill.sttp.client3" %% "async-http-client-backend-zio" % "3.0.0-RC3",
...
```scala
libraryDependencies ++= List(
  "com.softwaremill.sttp.client3" %% "async-http-client-backend-monix" % "3.0.0-RC3",
  "com.softwaremill.sttp.client3" %% "circe" % "3.0.0-RC3",
  "io.circe" %% "circe-generic" % "0.13.0"
)
```
...
```scala
libraryDependencies ++= List(
  "com.softwaremill.sttp.client3" %% "slf4j-backend" % "3.0.0-RC3",
  "com.softwaremill.sttp.client3" %% "circe" % "3.0.0-RC3",
  "io.circe" %% "circe-generic" % "0.13.0"
)
```
...
```scala
libraryDependencies ++= List("com.softwaremill.sttp.client3" %% "async-http-client-backend-zio" % "3.0.0-RC3")
```
...
```scala
libraryDependencies ++= List("com.softwaremill.sttp.client3" %% "async-http-client-backend-fs2 % "3.0.0-RC3")
```
...
```scala
libraryDependencies ++= List("com.softwaremill.sttp.client3" %% "async-http-client-backend-monix % "3.0.0-RC3")
```
...
```scala
libraryDependencies ++= List("com.softwaremill.sttp.client3" %% "akka-http-backend" % "3.0.0-RC3")
```
