...
```scala
"com.softwaremill.sttp.client" %% "core" % "2.2.2-SNAPSHOT"
```
...
```scala
import $ivy.`com.softwaremill.sttp.client::core:2.2.2-SNAPSHOT`
...
```scala
import $ivy.`com.softwaremill.sttp.client::okhttp-backend:2.2.2-SNAPSHOT`
