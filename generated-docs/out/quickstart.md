...
```scala
import $ivy.`com.softwaremill.sttp.client4::core:4.0.24`
```
...
```scala
//> using dep com.softwaremill.sttp.client4::core:4.0.24
//> using dep com.softwaremill.sttp.client4::upickle:4.0.24
...
```
"com.softwaremill.sttp.client4" %% "slf4j-backend" % "4.0.24"
```
