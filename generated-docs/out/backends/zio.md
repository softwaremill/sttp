...
"com.softwaremill.sttp.client3" %% "zio1" % "3.8.16" // for ZIO 1.x
```
...
```
"com.softwaremill.sttp.client3" %% "armeria-backend-zio" % "3.8.16"  // for ZIO 2.x
"com.softwaremill.sttp.client3" %% "armeria-backend-zio1" % "3.8.16" // for ZIO 1.x
```
