...
```
"com.softwaremill.sttp.client4" %% "zio" % "4.0.0-M14"  // for ZIO 2.x
"com.softwaremill.sttp.client4" %% "zio1" % "4.0.0-M14" // for ZIO 1.x
```
...
```
"com.softwaremill.sttp.client4" %% "armeria-backend-zio" % "4.0.0-M14"  // for ZIO 2.x
"com.softwaremill.sttp.client4" %% "armeria-backend-zio1" % "4.0.0-M14" // for ZIO 1.x
```
