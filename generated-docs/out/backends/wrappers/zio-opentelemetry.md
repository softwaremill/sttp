...
```
"com.softwaremill.sttp.client3" %% "zio-telemetry-opentelemetry-backend" % "3.5.2"  // for ZIO 2.x
"com.softwaremill.sttp.client3" %% "zio1-telemetry-opentelemetry-backend" % "3.5.2" // for ZIO 1.x
```
