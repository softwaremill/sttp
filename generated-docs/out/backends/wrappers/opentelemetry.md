...
```
"com.softwaremill.sttp.client3" %% "opentelemetry-metrics-backend" % "3.7.2"
```
...
```
"com.softwaremill.sttp.client3" %% "opentelemetry-tracing-zio-backend" % "3.7.2"  // for ZIO 2.x
"com.softwaremill.sttp.client3" %% "opentelemetry-tracing-zio1-backend" % "3.7.2" // for ZIO 1.x
```
