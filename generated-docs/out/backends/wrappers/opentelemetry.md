...
```
"com.softwaremill.sttp.client4" %% "opentelemetry-metrics-backend" % "4.0.0-M3"
```
...
```
"com.softwaremill.sttp.client4" %% "opentelemetry-tracing-zio-backend" % "4.0.0-M3"  // for ZIO 2.x
```
