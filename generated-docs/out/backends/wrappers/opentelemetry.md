...
```
"com.softwaremill.sttp.client4" %% "opentelemetry-backend" % "4.0.10"
```
...
```
"com.softwaremill.sttp.client4" %% "opentelemetry-tracing-zio-backend" % "4.0.10"  // for ZIO 2.x
```
...
```scala
"com.softwaremill.sttp.client4" %% "opentelemetry-otel4s-metrics-backend" % "4.0.10"
```
...
Add the following dependency to your project:
```scala
"com.softwaremill.sttp.client4" %% "opentelemetry-otel4s-tracing-backend" % "4.0.10"
```
