...
```
"com.softwaremill.sttp.client3" %% "core" % "3.8.9" % Test classifier "tests"
```
...
```scala
"com.softwaremill.sttp.client3" %% "cats" % "3.8.9" // for cats-effect 3.x
// or
"com.softwaremill.sttp.client3" %% "catsce2" % "3.8.9" // for cats-effect 2.x
```
