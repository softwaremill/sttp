...
```
"com.softwaremill.sttp.client4" %% "core" % "4.0.0" % Test classifier "tests"
```
...
```scala
"com.softwaremill.sttp.client4" %% "cats" % "4.0.0" // for cats-effect 3.x
// or
"com.softwaremill.sttp.client4" %% "catsce2" % "4.0.0" // for cats-effect 2.x
```
