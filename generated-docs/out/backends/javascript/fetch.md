...
```
"com.softwaremill.sttp.client4" %%% "monix" % "4.0.16"
```
...
```
"com.softwaremill.sttp.client4" %%% "zio" % "4.0.16"
```
...
```
"com.softwaremill.sttp.client4" %%% "fs2" % "4.0.16"
```
