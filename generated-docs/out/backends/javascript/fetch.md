...
```
"com.softwaremill.sttp.client4" %%% "monix" % "4.0.0-RC4"
```
...
```
"com.softwaremill.sttp.client4" %%% "zio" % "4.0.0-RC4"
```
...
```
"com.softwaremill.sttp.client4" %%% "cats" % "4.0.0-RC4"
```

If you are on Cats Effect 2 (CE2) you will need to add the CE2 specific dependency instead:

```
"com.softwaremill.sttp.client4" %%% "catsce2" % "4.0.0-RC4"
```
