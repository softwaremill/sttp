...
```scala
"com.softwaremill.sttp.client3" %% "async-http-client-backend-fs2" % "3.2.1"
```
...
```
"com.softwaremill.sttp.client3" %% "httpclient-backend-fs2" % "3.2.1"
```
...
```
"com.softwaremill.sttp.client3" %% "armeria-backend-fs2" % "3.2.1"
```
