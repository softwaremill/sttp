...
```scala
"com.softwaremill.sttp.client3" %% "fs2" % "3.8.8" // for cats-effect 3.x & fs2 3.x
// or 
"com.softwaremill.sttp.client3" %% "fs2-ce2" % "3.8.8" // for cats-effect 2.x & fs2 2.x
```
...
```scala
"com.softwaremill.sttp.client3" %% "armeria-backend-fs2" % "3.8.8" // for cats-effect 3.x & fs2 3.x
// or
"com.softwaremill.sttp.client3" %% "armeria-backend-fs2" % "3.8.8" // for cats-effect 2.x & fs2 2.x
```
