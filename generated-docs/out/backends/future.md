...
```scala
"com.softwaremill.sttp.client3" %% "async-http-client-backend-future" % "3.3.4"
```
...
```scala
"com.softwaremill.sttp.client3" %% "okhttp-backend" % "3.3.4"
```
...
```
"com.softwaremill.sttp.client3" %% "armeria-backend-future" % "3.3.4"
```
