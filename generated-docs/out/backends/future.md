...
```scala
"com.softwaremill.sttp.client3" %% "async-http-client-backend-future" % "3.7.5"
```
...
```scala
"com.softwaremill.sttp.client3" %% "okhttp-backend" % "3.7.5"
```
...
```
"com.softwaremill.sttp.client3" %% "armeria-backend" % "3.7.5"
```
