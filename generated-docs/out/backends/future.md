...
```scala
"com.softwaremill.sttp.client3" %% "async-http-client-backend-future" % "3.2.2"
```
...
```scala
"com.softwaremill.sttp.client3" %% "okhttp-backend" % "3.2.2"
```
...
```
"com.softwaremill.sttp.client3" %% "httpclient-backend" % "3.2.2"
```
...
```
"com.softwaremill.sttp.client3" %% "armeria-backend-future" % "3.2.2"
```
