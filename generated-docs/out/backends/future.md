...
```scala
"com.softwaremill.sttp.client3" %% "async-http-client-backend-future" % "3.1.8"
```
...
```scala
"com.softwaremill.sttp.client3" %% "okhttp-backend" % "3.1.8"
```
...
```
"com.softwaremill.sttp.client3" %% "httpclient-backend" % "3.1.8"
```
...
```
"com.softwaremill.sttp.client3" %% "armeria-backend-future" % "3.1.8"
```
