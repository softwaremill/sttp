...
```
"com.softwaremill.sttp.client4" %% "monix" % "4.0.6"
```
...
```scala
"com.softwaremill.sttp.client4" %% "okhttp-backend-monix" % "4.0.6"
```
...
```
"com.softwaremill.sttp.client4" %% "armeria-backend-monix" % "4.0.6"
```
