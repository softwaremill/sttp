...
```
"com.softwaremill.sttp.client4" %% "monix" % "4.0.0-RC3"
```
...
```scala
"com.softwaremill.sttp.client4" %% "okhttp-backend-monix" % "4.0.0-RC3"
```
...
```
"com.softwaremill.sttp.client4" %% "armeria-backend-monix" % "4.0.0-RC3"
```
