...
```
"com.softwaremill.sttp.client4" %% "monix" % "4.0.5"
```
...
```scala
"com.softwaremill.sttp.client4" %% "okhttp-backend-monix" % "4.0.5"
```
...
```
"com.softwaremill.sttp.client4" %% "armeria-backend-monix" % "4.0.5"
```
