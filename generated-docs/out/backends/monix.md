...
```scala
"com.softwaremill.sttp.client3" %% "okhttp-backend-monix" % "3.3.2"
```
...
```
"com.softwaremill.sttp.client3" %% "httpclient-backend-monix" % "3.3.2"
```
...
```
"com.softwaremill.sttp.client3" %% "armeria-backend-monix" % "3.3.2"
```
