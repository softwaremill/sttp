...
```
"com.softwaremill.sttp.client4" %% "monix" % "4.0.0-M24"
```
...
```scala
"com.softwaremill.sttp.client4" %% "okhttp-backend-monix" % "4.0.0-M24"
```
...
```
"com.softwaremill.sttp.client4" %% "armeria-backend-monix" % "4.0.0-M24"
```
