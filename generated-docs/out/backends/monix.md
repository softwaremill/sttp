...
```
"com.softwaremill.sttp.client3" %% "monix" % "3.7.1"
```
...
```scala
"com.softwaremill.sttp.client3" %% "okhttp-backend-monix" % "3.7.1"
```
...
```
"com.softwaremill.sttp.client3" %% "armeria-backend-monix" % "3.7.1"
```
