...
```
"com.softwaremill.sttp.client4" %% "monix" % "4.0.0-M25"
```
...
```scala
"com.softwaremill.sttp.client4" %% "okhttp-backend-monix" % "4.0.0-M25"
```
...
```
"com.softwaremill.sttp.client4" %% "armeria-backend-monix" % "4.0.0-M25"
```
