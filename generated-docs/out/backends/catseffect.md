...
```scala
"com.softwaremill.sttp.client4" %% "armeria-backend-cats" % "4.0.0-M6" // for cats-effect 3.x
// or
"com.softwaremill.sttp.client4" %% "armeria-backend-cats-ce2" % "4.0.0-M6" // for cats-effect 2.x
```
