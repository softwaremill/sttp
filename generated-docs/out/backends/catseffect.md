...
```scala
"com.softwaremill.sttp.client3" %% "armeria-backend-cats" % "3.9.5" // for cats-effect 3.x
// or
"com.softwaremill.sttp.client3" %% "armeria-backend-cats-ce2" % "3.9.5" // for cats-effect 2.x
```
