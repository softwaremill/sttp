...
```scala
"com.softwaremill.sttp.client4" %% "cats" % "4.0.0-RC3"
```
...
```scala
// for cats-effect 3.x
"com.softwaremill.sttp.client4" %% "armeria-backend-cats" % "4.0.0-RC3" 
// or for cats-effect 2.x
"com.softwaremill.sttp.client4" %% "armeria-backend-cats-ce2" % "4.0.0-RC3" 
```
