...
```scala
"com.softwaremill.sttp.client3" %% "async-http-client-backend-cats" % "3.3.16" // for cats-effect 3.x
// or
"com.softwaremill.sttp.client3" %% "async-http-client-backend-cats-ce2" % "3.3.16" // for cats-effect 2.x
```
...
```scala
"com.softwaremill.sttp.client3" %% "armeria-backend-cats" % "3.3.16" // for cats-effect 3.x
// or
"com.softwaremill.sttp.client3" %% "armeria-backend-cats-ce2" % "3.3.16" // for cats-effect 2.x
```
