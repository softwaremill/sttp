...
Required dependencies::
  ...
  libraryDependencies ++= List("com.softwaremill.sttp.client" %% "core" % "2.0.0-RC4")
...
Required dependencies::
  ...
  libraryDependencies ++= List(
    "com.softwaremill.sttp.client" %% "akka-http-backend" % "2.0.0-RC4",
    "com.softwaremill.sttp.client" %% "json4s" % "2.0.0-RC4",
