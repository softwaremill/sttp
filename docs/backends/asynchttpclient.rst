...
To use, add the following dependency to your project::
  ...
  "com.softwaremill.sttp" %% "async-http-client-backend-future" % "1.0.4"
  // or
  "com.softwaremill.sttp" %% "async-http-client-backend-scalaz" % "1.0.4"
  // or
  "com.softwaremill.sttp" %% "async-http-client-backend-monix" % "1.0.4"
  // or
  "com.softwaremill.sttp" %% "async-http-client-backend-cats" % "1.0.4"
