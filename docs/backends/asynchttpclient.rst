...
To use, add the following dependency to your project::
  ...
  // or
  "com.softwaremill.sttp" %% "async-http-client-backend-scalaz" % "1.3.1"
  // or
  "com.softwaremill.sttp" %% "async-http-client-backend-monix" % "1.3.1"
  // or
  "com.softwaremill.sttp" %% "async-http-client-backend-cats" % "1.3.1"
  // or
