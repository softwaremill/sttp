...
To use, add the following dependency to your project::
  ...
  // or
  "com.softwaremill.sttp" %% "async-http-client-backend-scalaz" % "1.5.2"
  // or
  "com.softwaremill.sttp" %% "async-http-client-backend-monix" % "1.5.2"
  // or
  "com.softwaremill.sttp" %% "async-http-client-backend-cats" % "1.5.2"
  // or
  "com.softwaremill.sttp" %% "async-http-client-backend-fs2" % "1.5.2"
