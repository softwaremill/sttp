...
To use, add the following dependency to your project::
  ...
  "com.softwaremill.sttp.client" %% "async-http-client-backend-future" % "2.0.0-RC5"
  // or
  "com.softwaremill.sttp.client" %% "async-http-client-backend-scalaz" % "2.0.0-RC5"
  // or
  ...
  // or
  "com.softwaremill.sttp.client" %% "async-http-client-backend-monix" % "2.0.0-RC5"
  // or
  "com.softwaremill.sttp.client" %% "async-http-client-backend-cats" % "2.0.0-RC5"
  // or
  "com.softwaremill.sttp.client" %% "async-http-client-backend-fs2" % "2.0.0-RC5"
