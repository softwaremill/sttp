...
To use, add the following dependency to your project::
  ...
  "com.softwaremill.sttp" %% "async-http-client-backend-future" % "1.2.0-RC1"
  // or
  "com.softwaremill.sttp" %% "async-http-client-backend-scalaz" % "1.2.0-RC1"
  // or
  "com.softwaremill.sttp" %% "async-http-client-backend-monix" % "1.2.0-RC1"
  // or
  "com.softwaremill.sttp" %% "async-http-client-backend-cats" % "1.2.0-RC1"
  // or
  "com.softwaremill.sttp" %% "async-http-client-backend-fs2" % "1.2.0-RC1"
