...
Since 2.0.0-RC4 brave-backend is deprecated, you should use :ref:`opentracing backend <opentracing_backend>` with brave integration.

To use, add the following dependency to your project::

  "com.softwaremill.sttp.client" %% "brave-backend" % "2.0.0-RC4"
