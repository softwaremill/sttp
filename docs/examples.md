...
```scala            
libraryDependencies ++= List("com.softwaremill.sttp.client" %% "core" % "2.0.0-RC13")
```
...
libraryDependencies ++= List(
  ...
  "com.softwaremill.sttp.client" %% "json4s" % "2.0.0-RC13",
...
```scala
libraryDependencies ++= List(
  "com.softwaremill.sttp.client" %% "async-http-client-backend-monix" % "2.0.0-RC13",
...
```scala
libraryDependencies ++= List("com.softwaremill.sttp.client" %% "async-http-client-backend-zio" % "2.0.0-RC13")
```
...
```scala
libraryDependencies ++= List("com.softwaremill.sttp.client" %% "async-http-client-backend-fs2" % "2.0.0-RC13")
```
