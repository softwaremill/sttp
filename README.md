...
scaladoc is available at [https://www.javadoc.io](https://www.javadoc.io/doc/com.softwaremill.sttp.client3/core_2.12/3.8.7)
...
```scala
import $ivy.`com.softwaremill.sttp.client3::core:3.8.7`
...
That is, in sbt run: `set version := "3.8.7"`, before running `mdoc` in `docs`.
