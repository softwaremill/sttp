...
scaladoc is available at [https://www.javadoc.io](https://www.javadoc.io/doc/com.softwaremill.sttp.client4/core_2.12/4.0.0-M7)
...
```
//> using lib "com.softwaremill.sttp.client4::core:4.0.0-M7"
...
```scala
import $ivy.`com.softwaremill.sttp.client4::core:4.0.0-M7`
import sttp.client4.quick._
quickRequest.get(uri"http://httpbin.org/ip").send()
```
...
That is, in sbt run: `set version := "4.0.0-M7"`, before running `mdoc` in `docs`.
