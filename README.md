...
scaladoc is available at [https://www.javadoc.io](https://www.javadoc.io/doc/com.softwaremill.sttp.client/core_2.12/2.0.0-M11)
...
```scala
import $ivy.`com.softwaremill.sttp.client::core:2.0.0-M11`
...
```scala
"com.softwaremill.sttp.client" %% "core" % "2.0.0-M11"
```
