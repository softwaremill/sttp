...
scaladoc is available at [https://www.javadoc.io](https://www.javadoc.io/doc/com.softwaremill.sttp.client4/core_2.12/4.0.0-RC3)
...
That is, in sbt run: `set ThisBuild/version := "4.0.0-RC3"`, before running `mdoc` in `docs`.
