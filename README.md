...
scaladoc is available at [https://www.javadoc.io](https://www.javadoc.io/doc/com.softwaremill.sttp.client3/core_2.12/3.3.0-RC2)
...
```scala
import $ivy.`com.softwaremill.sttp.client3::core:3.3.0-RC2`
...
That is, in sbt run: `set version := "3.3.0-RC2"`, before running `mdoc` in `docs`.
