...
scaladoc is available at [https://www.javadoc.io](https://www.javadoc.io/doc/com.softwaremill.sttp.client4/core_3/4.0.13)
...
```scala
import $ivy.`com.softwaremill.sttp.client4::core:4.0.13`
import sttp.client4.quick.*
quickRequest.get(uri"http://httpbin.org/ip").send()
```
