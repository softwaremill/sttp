...
```scala
import $ivy.`com.softwaremill.sttp::core:0.0.17`
import com.softwaremill.sttp._
implicit val backend = HttpURLConnectionBackend()
...
```scala
"com.softwaremill.sttp" %% "core" % "0.0.17"
```
...
```scala
"com.softwaremill.sttp" %% "akka-http-backend" % "0.0.17"
```
...
```scala
"com.softwaremill.sttp" %% "async-http-client-backend-future" % "0.0.17"
// or
"com.softwaremill.sttp" %% "async-http-client-backend-scalaz" % "0.0.17"
// or
"com.softwaremill.sttp" %% "async-http-client-backend-monix" % "0.0.17"
// or
"com.softwaremill.sttp" %% "async-http-client-backend-cats" % "0.0.17"
```
...
```scala
"com.softwaremill.sttp" %% "okhttp-backend" % "0.0.17"
// or, for the monix version:
"com.softwaremill.sttp" %% "okhttp-backend-monix" % "0.0.17"
```
...
```scala
"com.softwaremill.sttp" %% "circe" % "0.0.17"
```
