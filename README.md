...
scaladoc is available at [https://www.javadoc.io](https://www.javadoc.io/doc/com.softwaremill.sttp.client3/core_2.12/3.9.3)
...
That is, in sbt run: `set version := "3.9.3"`, before running `mdoc` in `docs`.
